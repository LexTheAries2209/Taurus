        ...
        VStack (spacing: 1) {
            ...
            if cameradata.BrandName == "ARRI" {
                ...
                Text("3. Prores为Apple开发的帧内压缩编码。iPhone系列机型视频录制采用可变帧速率（VFR），实际帧速率可能与拍摄选择帧速率不同。")
                    ...
                    .padding(.leading,10)
                    .frame(maxWidth: .infinity,alignment:.leading)
                Text("4. 相机应用录制的Prores规格为Prores 422 HQ，根据机型不同，在内录视频时对分辨率与帧率有所限制；使用第三方录制软件以绕过限制。")
                    .font(.system(size: 10))
                    .padding(.leading,10)
                    .frame(maxWidth: .infinity,alignment:.leading)
            }
                ...
                Text("2. DCI 4K指分辨率为4096x2160，DCI 2K指分辨率为2048x1080；FHD指分辨率1920x1080；UHD指分辨率3840x2160。")
                    ...
                    .padding(.leading,10)
                    .frame(maxWidth: .infinity,alignment:.leading)
                Text("3. Prores RAW HQ为Apple开发的12bit非线性压缩RAW编码；Prores为Apple开发的帧内压缩编码；CinemaDNG为ADOBE开发的无损压缩RAW编码。")
                    .font(.system(size: 10))
                    .padding(.leading,10)
                    .frame(maxWidth: .infinity,alignment:.leading)
                ...
                Text("2. 默认宽高比为16:9，DCI 4K指分辨率为4096x2160；DCI 2K指分辨率为2048x1080；FHD指分辨率1920x1080；UHD指分辨率3840x2160。")
                    ...
                    .padding(.leading,10)
                    .frame(maxWidth: .infinity,alignment:.leading)
                Text("3. Prores RAW为Apple开发的12bit非线性压缩RAW编码；Prores为Apple开发的帧内压缩编码；ALL-I指帧内压缩；IPB指帧间压缩。")
                    .font(.system(size: 10))
                    .padding(.leading,10)
                    .frame(maxWidth: .infinity,alignment:.leading)
