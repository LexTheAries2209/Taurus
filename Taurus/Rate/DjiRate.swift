...
func DjiRate(cameradata:CameraData) -> [String] {
    ...
    if cameradata.CameraName == "Ronin 4D[8K]" {
        ...
        if cameradata.Resolution == "6K FF[6008*3168][17:9]" || cameradata.Resolution == "6K FF[5632*3168][16:9]" || cameradata.Resolution == "4K FF[4096*2160][17:9]" || cameradata.Resolution == "4K FF[3840*2160][16:9]" {
            rates = ["23.976","24.000","25.000","29.970","30.000","48.000"]
        }
        else if cameradata.Resolution == "2K FF[2048*1080][17:9]" || cameradata.Resolution == "2K FF[1920*1080][16:9]" {
            rates = ["23.976","24.000","25.000","29.970","30.000","48.000","50.000","59.940","60.000","72.000","75.000","96.000","100.000","120.000"]
        }
        else if cameradata.Resolution == "4K FF[4096*1712][2.39:1]" {
            rates = ["59.940","60.000"]
        }
        else if cameradata.Resolution == "4K S35[4096*1712][2.39:1]" {
            rates = ["100.000","120.000"]
        }
        else if cameradata.Resolution.contains("4K S35") || cameradata.Resolution.contains("2K S35") {
            rates = ["23.976","24.000","25.000","29.970","30.000","48.000","50.000","59.940","60.000","72.000","75.000","96.000"]
        }
        else if cameradata.Resolution.contains("crop") {
            rates = ["50.000"]
        }
