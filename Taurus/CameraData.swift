...
final class CameraData: ObservableObject {
    ...
    @Published var BrandName = CameraData.brandPlaceholder
    @Published var CameraName = CameraData.cameraPlaceholder
    @Published var Codec = CameraData.codecPlaceholder
    @Published var CanonCodecLevel = CameraData.codecLevelPlaceholder
    @Published var Resolution = CameraData.resolutionPlaceholder
    @Published var Media = CameraData.mediaPlaceholder
    @Published var Rate = CameraData.frameRatePlaceholder
    @Published var Format = CameraData.formatPlaceholder
