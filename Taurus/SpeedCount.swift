...
//分辨率乘积
public var ResolutionMultiplier: Double {
...
//旧机型Prores编码码率乘积
public var ProresCompensation: Double {
...
public var ARRIRAWCompensation: Double {
    switch cameraData.CameraName {
    case "ALEXA 35" :
        return 1.075
    default :
...
//索尼机型码率计算区
public var SonyCodecName: String = cameraData.Codec + "_" + cameraData.Resolution
public var SonyCodecSpeed: Double {
...
//佳能机型码率计算区
public var CanonCodecName: String = cameraData.Codec + "_" + cameraData.Resolution
public var CanonCodecSpeed: Double {
...
public var PanaCodecName: String = cameraData.Codec + "_" + cameraData.Resolution
public var PanaCodecSpeed: Double {
...
//存储卡容量乘积
public var MediaCapacity: Double {
...
//加入补偿的编码速度
public var CodecSpeedCount: Double {
    switch cameraData.Codec {
