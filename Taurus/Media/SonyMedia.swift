...
func SonyMedia(cameradata:CameraData) -> [String] {
    ...
    if cameradata.CameraName == "A7S3" || cameradata.CameraName == "FX 3" || cameradata.CameraName == "FX 30" || cameradata.CameraName == "A1" || cameradata.CameraName == "A9M3" || cameradata.CameraName == "A1M2" || cameradata.CameraName == "A7M5" || cameradata.CameraName == "A7R6" {
