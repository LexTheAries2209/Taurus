    ...
    if cameradata.CameraName == "S1H" {
        ...
        if cameradata.Codec == "Prores RAW HQ" || cameradata.Codec == "Prores RAW" {
            if cameradata.Format == "M43" {
                PanaResolution = ["DCI 5.7K[5728*3024][12bit RAW][23.98p]","DCI 5.7K[5728*3024][12bit RAW][24p]","DCI 5.7K[5728*3024][12bit RAW][25p]","DCI 5.7K[5728*3024][12bit RAW][29.97p]","DCI 4K[12bit RAW][23.98p]","DCI 4K[12bit RAW][24p]","DCI 4K[12bit RAW][25p]","DCI 4K[12bit RAW][29.97p]","DCI 4K[12bit RAW][50p]","DCI 4K[12bit RAW][59.94p]"]
            }
            else {
                PanaResolution = ["DCI 4K[12bit RAW][23.98p]","DCI 4K[12bit RAW][24p]","DCI 4K[12bit RAW][25p]","DCI 4K[12bit RAW][29.97p]","DCI 4K[12bit RAW][50p]","DCI 4K[12bit RAW][59.94p]"]
            }
        }
