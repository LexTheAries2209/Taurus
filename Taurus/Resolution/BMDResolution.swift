...
func BMDResolution(cameradata:CameraData) -> [String] {
    ...
    if cameradata.BrandName == "Blackmagicdesign" {
            ...
            let BMDResolutions: [String: [String]] = [
                ...
                "Blackmagic URSA Mini Pro 4.6K G2_Prores 4444 XQ" : ["4.6K S35[4608*2592][16:9]","4.6K S35[4608*1920][2.4:1]","4K S35[4096*2304][16:9]","4K S35[4096*2160][17:9]","4K S35[3840*2160][16:9]","2K S35[2048*1152][16:9]","2K S35[2048*1080][17:9]","2K S35[1920*1080][16:9]"],
            ]
