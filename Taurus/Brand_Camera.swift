...
public let CameraModel : [String:[String]] = [
    ...
    "Canon Cinema" : ["CinemaEOS C70","CinemaEOS R5C"],
    //"Canon" : ["CinemaEOS C500 Mark2","CinemaEOS C300 Mark3","CinemaEOS C400","CinemaEOS C300 Mark2","CinemaEOS C200","CinemaEOS C100 Mark2","EOS 1D-X Mark3"],
