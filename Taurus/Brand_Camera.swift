...
public let CameraModel : [String:[String]] = [
    ...
    //"SONY" : ["CineAlta Venice","CineAlta Venice 2[8K]","CineAlta Venice 2[6K]"],
    "SONY" : ["CineAlta Burano","FX 9","FX 6","FX 3","FX 30","Alpha 1","A9M3","A7S3","A7R5","A7M4","A7C2","A7CR","ZV-E1","A6700"],
